...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-secondary to-engineering-gray">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-engineering-steel font-medium">
                20+ Years in Engineering, Design & NPD
              </p>
            </div>
            ...
            <div className="p-6 bg-card/50 backdrop-blur-sm rounded-lg border border-engineering-blue/20">
              ...
              <p className="text-muted-foreground">
                Helping students build confidence, understand industry workflows, 
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-card rounded-lg p-4 shadow-lg border">
              <div className="text-center">
                <div className="text-2xl font-bold text-engineering-blue">20+</div>
            ...
            <div className="absolute -top-6 -right-6 bg-card rounded-lg p-4 shadow-lg border">
              <div className="text-center">
                <div className="text-2xl font-bold text-engineering-accent">100+</div>
