...
const ServicesSection = () => {
  return (
    <section className="pt-20 bg-background" id="services">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {guestLectureTopics.map((topic, index) => (
                  <div
                    key={index}
                    className="flex items-start space-x-3 p-3 rounded-lg bg-engineering-blue/5 border border-engineering-blue/10
                   transition-all duration-300 transform hover:scale-[1.02] hover:shadow-md hover:bg-engineering-blue/10"
                  >
                    <BookOpen
                      className="h-5 w-5 text-engineering-blue mt-0.5 flex-shrink-0 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110"
                    />
        ...
        <div className="bg-gradient-to-r from-engineering-blue/5 to-engineering-accent/5 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center border-engineering-blue/20">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Strategic guidance tailored for young professionals with 0–5 years of experience,
                  covering career path planning, essential industry skills, and development roadmaps.
                </p>
              </CardContent>
            </Card>
